...
const Experience = () => {
  return (
    <div className="w-full h-full p-4 px-6 gap-4 font-lekton">
      <div className="max-w-[1200px] h-full border-y-2 lg:border-2 border-second flex flex-col items-center mx-auto gap-10 pt-10 pb-10 p-0 lg:p-6">
        <p className="text-[8vmin] text-second">my experience</p>
...
const Technologies = () => {
  return (
    <div className="flex flex-col gap-4 lg:flex-row">
      <div className="border-2 h-full border-second flex flex-col w-full p-6 gap-4 font-normal">
      ...
      <div className="border-2 border-second flex flex-col w-full p-6 gap-4 font-normal">
        ...
        <p className="leading-5 border-l-2 pl-2 border-second">
          Worked with Node, Prisma, Postgresql, Firebase Firestore, Python,
          Django.
        </p>
      </div>
      ...
      <div className="border-2 border-second flex flex-col w-full  p-6 gap-4 font-normal">
        ...
        <p className="leading-5 border-l-2 pl-2 border-second">
          Interested in the developemnt of AI technologies. User of GPT-4 and
          Github Copilot. Exploring langchain and OpenAI's API
        </p>
      </div>
    </div>
  );
